...
(function() {
  var PascalTri, bgcol, binomMod, ch, clearCanvas, col_array, container, cw, el, endColor, fullLColor, gui, guiparam, lColor, m, mPI, mabs, matan, math, mceil, mcos, mfloor, mhrt, mmax, mmin, mrandom, mround, msin, msqrt, n, plineColor, plineWidth, redraw, startColor, tctx, tri, trianglescanvas, wlineWidth;
  ...
  gui.add(guiparam, 'subdivision', 2, 256, 1).onChange(function(val) {
    redraw(val);
  });
